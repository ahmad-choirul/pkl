...
<li class="green with-sub <?php if($uri1=='kabko_suratkeluar') { echo 'opened'; } ?>">
    ...
    <ul>
        <li <?php if($uri12=='kabko_suratkeluarindex') { echo 'class="menuaktif"'; } ?>><a href="<?php echo base_url(); ?>kabko_suratkeluar/index"><span class="lbl">Draft</span></a></li>
        <li <?php if($uri12=='kabko_suratkeluardaftar') { echo 'class="menuaktif"'; } ?>><a href="<?php echo base_url(); ?>kabko_suratkeluar/daftar"><span class="lbl">Daftar</span></a></li>
...
<li class="magenta with-sub <?php if($uri1=='kabko_disposisi') { echo 'opened'; } ?>">
    ...
    <ul>
        <li <?php if($uri12=='kabko_disposisipelaksana') { echo 'class="menuaktif"'; } ?>><a href="<?php echo base_url(); ?>kabko_disposisi/pelaksana"><span class="lbl">Respon</span></a></li>
        <li <?php if($uri12=='kabko_disposisidaftarpelaksana') { echo 'class="menuaktif"'; } ?>><a href="<?php echo base_url(); ?>kabko_disposisi/daftarpelaksana"><span class="lbl">Daftar</span></a></li>
    </ul>
</li>
