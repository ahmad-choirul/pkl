	                ...
	                <div class="site-header-shown">
	                        ...
	                        <div class="dropdown-menu dropdown-menu-right dropdown-menu-notif" aria-labelledby="dd-notification">
	                            ...
	                            <div class="dropdown-menu-notif-list">
	                                <div class="dropdown-menu-notif-item">
	                                    <div class="photo">
	                                        <img src="<?php base_url(); ?>assets/theme/img/photo-64-1.jpg" alt="">
	                                    </div>
	                                    <div class="dot"></div>
	                                ...
	                                <div class="dropdown-menu-notif-item">
	                                    <div class="photo">
	                                        <img src="<?php base_url(); ?>assets/theme/img/photo-64-2.jpg" alt="">
	                                    </div>
	                                    <div class="dot"></div>
	                                ...
	                                <div class="dropdown-menu-notif-item">
	                                    <div class="photo">
	                                        <img src="<?php base_url(); ?>assets/theme/img/photo-64-3.jpg" alt="">
	                                    </div>
	                                    <div class="dot"></div>
	                                ...
	                                <div class="dropdown-menu-notif-item">
	                                    <div class="photo">
	                                        <img src="<?php base_url(); ?>assets/theme/img/photo-64-4.jpg" alt="">
	                                    </div>
	                                ...
	                                <div class="tab-pane active" id="tab-incoming" role="tabpanel">
	                                    <div class="dropdown-menu-messages-list">
	                                        <a href="#" class="mess-item">
	                                            <span class="avatar-preview avatar-preview-32"><img src="<?php base_url(); ?>assets/theme/img/photo-64-2.jpg" alt=""></span>
	                                            <span class="mess-item-name">Tim Collins</span>
	                                            <span class="mess-item-txt">Morgan was bothering about something!</span>
	                                        </a>
	                                        <a href="#" class="mess-item">
	                                            <span class="avatar-preview avatar-preview-32"><img src="<?php base_url(); ?>assets/theme/img/avatar-2-64.png" alt=""></span>
	                    ...
	                    <div class="dropdown user-menu">
	                        <button class="dropdown-toggle" id="dd-user-menu" type="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
	                            <img src="<?php base_url(); ?>assets/theme/img/avatar-2-64.png" alt="">
	                        </button>
