...
?><div class="bDiv" >
		...
		<thead>
			<tr class='hDiv'>
				<!-- nomer urut 
				<th>
					<div class="text-left field-sorting" style="width: 30px !important;">
						#
					</div>
				</th>
				<!-- end nomer urut -->
...
<?php foreach($list as $num_row => $row){ ?>        
		<tr  <?php if($num_row % 2 == 1){?>class="erow"<?php }?>>
   			<!-- nomer urut <td style="text-align: right; padding-right: 5px; padding-top: 5px;"><?php echo  ($num_row + 1);?></td> <!-- nomer urut -->
			<?php foreach($columns as $column){?>
